...
if (!targetDir) throw new Error('Usage: node scripts/deploy-hisense-patch.js <target-dir>');
async function download(name) { const r = await fetch(base + name); if (!r.ok) throw new Error(`${name}: ${r.status}`); return r.text(); }
function once(s, a, b, label) { if (!s.includes(a)) throw new Error(`Missing patch target: ${label}`); return s.replace(a, () => b); }
function patchMain(s) {
  s = once(s, "@font-face {\\n  font-family: 'PlusJakartaSans';\\n  font-weight: 100 1000;\\n  src: url(${d}) format('truetype');\\n}", "/* @font-face removed */) format('truetype');\\n}", 'main font face');
  s = s.replaceAll("font-family: 'PlusJakartaSans';", 'font-family: sans-serif;');
  s = once(s, "font-family: 'PlusJakartaSans', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;", 'font-family: sans-serif;', 'main body font');
  s = once(s, 'seekNext:[418,417,176,208]}', 'seekNext:[418,417,176,208],green:[404],yellow:[405]}', 'main remote key map');
  s = once(s, 'const Qt=e=>{const{ref:t,focus:n}=(0,i.Wc)(),a=()=>{n()},l=({target:t})=>{const{value:n}=t;e.onInput&&e.onInput(n)},s=({target:t})=>{const{value:n}=t;e.onChange&&e.onChange(n)},c=({target:t})=>{const{value:n}=t;e.onSubmit&&e.onSubmit(n)};return(0,o.Rc)((()=>{e.autoFocus&&n()})),(u=Xt()).addEventListener("submit",c),u.addEventListener("change",s),u.$$input=l', 'const Qt=e=>{const{ref:t,focus:n}=(0,i.Wc)(),a=()=>{n()},l=({target:t})=>{const{value:n}=t;e.onInput&&e.onInput(n)},s=({target:t})=>{const{value:n}=t;e.onChange&&e.onChange(n)},c=({target:t})=>{const{value:n}=t;e.onSubmit&&e.onSubmit(n)},d=t=>{const n=t.keyCode||t.which;(13===n||405===n)&&(t.preventDefault(),e.onSubmit&&e.onSubmit(t.target.value)),e.onKeyDown&&e.onKeyDown(t)};return(0,o.Rc)((()=>{e.autoFocus&&n()})),(u=Xt()).addEventListener("submit",c),u.addEventListener("change",s),u.addEventListener("keydown",d),u.$$input=l', 'main text input keydown');
  s = once(s, 't("seekNext")&&(e.preventDefault(),y("seekNext"))}', 't("seekNext")&&(e.preventDefault(),y("seekNext")),t("green")&&(e.preventDefault(),y("green")),t("yellow")&&(e.preventDefault(),y("yellow"))}', 'main color key dispatch');
  return s;
}
function patchSearch(s) {
  s = once(s, '[E,w]=(0,a.n5)(null),[C,Y,K]=(0,o.zD)(),k=()=>', '[E,w]=(0,a.n5)(null),[C,Y,K]=(0,o.zD)(),q=(0,G.cq)(),k=()=>', 'search nav service');
  s = once(s, 'P=e=>{g({query:e})},T=e=>{b(e)}', 'P=e=>{g({query:e})},D=()=>{P(k())},B=e=>{const n=e.keyCode||e.which;(13===n||405===n)&&(e.preventDefault(),P(e.target.value))},T=e=>{b(e)}', 'search submit handlers');
  s = once(s, '(0,a.Ki)((()=>{v.unload()}))', '(0,a.Rc)((()=>{q.on("yellow",D)})),(0,a.Ki)((()=>{q.off("yellow",D),v.unload()}))', 'search yellow lifecycle');
  s = once(s, 'get children(){return(0,a.a0)(l.ks,{get placeholder(){return d("STREMIO_TV_SEARCH_PLACEHOLDER")},get value(){return k()},autoFocus:!0,onChange:P,onSubmit:P})}})', 'get children(){return[(0,a.a0)(l.ks,{get placeholder(){return d("STREMIO_TV_SEARCH_PLACEHOLDER")},get value(){return k()},autoFocus:!0,onInput:P,onChange:P,onSubmit:P,onKeyDown:B}),(0,a.a0)(l.$n,{icon:"search",onPress:D})]}})', 'search button');
  s = once(s, 'padding: 2rem 4rem 1rem 4rem;\\n}\\n.search-guyhx .container-RxHME', 'padding: 2rem 4rem 1rem 4rem;\\n  display: flex;\\n  flex-direction: row;\\n  align-items: center;\\n}\\n.search-guyhx .heading-AvPuR > input {\\n  flex: 1 1 auto;\\n  min-width: 0;\\n}\\n.search-guyhx .heading-AvPuR > :last-child {\\n  flex: 0 0 auto;\\n  margin-left: 1rem;\\n}\\n.search-guyhx .container-RxHME', 'search CSS');
  return s;
}
function patchPlayer(s) {
  s = once(s, 'yn=()=>{!nn()&&!tn()&&!V()&&!j()&&we()},Sn=()=>{E(),Y(),L(),U(),q(),ne(),ie()},xn=()=>{Ie(!0),_(),we()};return', 'yn=()=>{!nn()&&!tn()&&!V()&&!j()&&we()},Sn=()=>{E(),Y(),L(),U(),q(),ne(),ie()},wn=()=>{Sn(),H()},xn=()=>{Ie(!0),_(),we()};return', 'player green handler');
  s = once(s, 'f.on("ok",kn),f.on("any",fn)', 'f.on("ok",kn),f.on("green",wn),f.on("any",fn)', 'player green listener');
  s = once(s, 'f.off("ok",kn),f.off("any",fn)', 'f.off("ok",kn),f.off("green",wn),f.off("any",fn)', 'player green cleanup');
  s = once(s, '(0,r.Yr)(n,(0,o.a0)(o.wv,{get when(){return Ze.audio().length},get children(){return(0,o.a0)(D,{icon:"audio",onClick:H})}}),null)', '(0,r.Yr)(n,(0,o.a0)(D,{icon:"audio",onClick:H}),null)', 'player audio button');
  return s;
}
